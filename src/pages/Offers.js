      ...
      <div className="w-[70%] shadow rounded py-12 lg:px-28 px-8">
        ...
        <div className="md:flex items-center mt-8">
          <div className="md:w-72 flex flex-col">
            ...
            <select onChange={(e) => setFule(e.target.value)} className="text-base leading-none text-gray-900 p-3 focus:oultine-none focus:border-indigo-700 mt-4 bg-gray-100 border rounded border-gray-200 placeholder-gray-100">
              <option value="petrol" key=""hii>Petrol</option>
              <option value="Desial" key=""hii>Desial</option>
              <option value="GAS" key=""hii>GAS</option>
            </select>
          </div>
          <div className="md:w-72 flex flex-col md:ml-6 md:mt-0 mt-4">
            <label className="text-base font-semibold leading-none text-gray-800">
